...
INSERT INTO enfermedades (id, nombre, descripcion, peligrosidad, contagiable)
VALUES (1, 'Gripe', 'Infección viral que afecta las vías respiratorias', 3, true),
...
INSERT INTO medicamentos (id, nombre, descripcion, precio, recetable)
VALUES (1, 'Paracetamol', 'Medicamento para aliviar el dolor y la fiebre', 50, true),
...
INSERT INTO enfermedades_medicamentos (id, id_enfermedad, id_medicamento)
VALUES (1, 1, 1), -- Gripe - Paracetamol
...
INSERT INTO tarjetas (id, tarjeta_banco)
VALUES (1, 'BBVA 1234 5678 9012 3456'),
...
INSERT INTO pacientes (id, NSS, edad, nombre, tarjeta, enfermedad, objetivo)
VALUES (1, 123, 45, 'Juan Pérez', 1, 1, 2000),      -- Tiene Gripe
...
INSERT INTO usuario_data(email, nombre, password, admin)
VALUES ("user@ua1", "usuarioPrueba", "123", true),
       ("user@ua", "usuarioPrueba", "123", true);

INSERT INTO usuario_tarjeta(usuario_id, tarjeta_id, cantidad)
VALUES (1, 1, 2000),
       (2, 2, 3000);

INSERT INTO usuario_data(email, nombre, password, admin, paciente)
VALUES ("user@ua2", "usuarioPaciente", "123", true, 1);